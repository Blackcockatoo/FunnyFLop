      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col gap-8 px-6 py-10">
        ...
        <section className="flex flex-col gap-6 lg:flex-row">
          <div className="flex-1 space-y-5 rounded-3xl border border-slate-800/60 bg-slate-900/70 p-6 shadow-glow backdrop-blur">
            ...
            <div className="rounded-3xl border border-slate-800/60 bg-slate-950/40 p-4 shadow-inner shadow-slate-950/50">
                  ...
                  row.map((cell, colIdx) => {
                    ...
                    return (
                      <button
                        ...
                        className="group relative flex aspect-square items-center justify-center rounded-xl text-2xl font-semibold transition-all duration-200 hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400"
                        style={{
                          ...visuals,
                ...
                {queueInfo.entries.slice(queuePointer, queuePointer + 10).map((entry) => {
                  ...
                  return (
                    <span
                      key={entry.index}
                      title={entry.label}
                      className="inline-flex items-center justify-center rounded-lg px-3 py-2 text-lg font-semibold shadow-inner shadow-slate-950/30"
                      style={{
                        ...badgeVisuals,
                        borderRadius: '0.9rem',
                      }}
